...
class _AddplaceState extends State<Addplace> {
  final CollectionReference place = FirebaseFirestore.instance.collection('place');
  TextEditingController placename = TextEditingController();
  TextEditingController placecity = TextEditingController();
  TextEditingController placedistrict = TextEditingController();
  TextEditingController placepin = TextEditingController();
  TextEditingController placephone = TextEditingController();

  void addStaff(){
    final data = {
      'name':placename.text,
      'city':placecity.text,
      'district':placedistrict.text,
      'pin':placepin.text,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text("City:",style: GoogleFonts.alegreya(
                                            textStyle: Theme.of(context).textTheme.headline4,
                                            fontSize: 20,
                                            color: Colors.teal[800],),),
                                          SizedBox(width: 52,),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text("District :",style: GoogleFonts.alegreya(
                                            textStyle: Theme.of(context).textTheme.headline4,
                                            fontSize: 20,
                                            color: Colors.teal[800],),),
                                          SizedBox(width:18,),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text("Pin :",style: GoogleFonts.alegreya(
                                            textStyle: Theme.of(context).textTheme.headline4,
                                            fontSize: 20,
                                            color: Colors.teal[800],),),
                                          SizedBox(width: 50,),
                                    ...
                                    Padding(
                                      ...
                                      child: ElevatedButton(
                                          onPressed: () {
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => viewplace()));
                                          },
                                          child: Text(
                                            "View Place",
                                            style: GoogleFonts.alegreya(
