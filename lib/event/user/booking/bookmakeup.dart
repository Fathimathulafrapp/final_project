...
class bookmakeup extends StatefulWidget {
  @override
  State<bookmakeup> createState() => _bookmakeupState();
}

class _bookmakeupState extends State<bookmakeup> {
  ...
  final CollectionReference menu = FirebaseFirestore.instance.collection('makeup');
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child:Row(
                                    children: [
                                      ...
                                      Text(foodsnap['Place'],style: GoogleFonts.alegreya(
                                        textStyle: Theme.of(context).textTheme.headline4,
                                        fontSize: 24,
                                        color: Colors.teal[800],),
                                      ),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 10,right: 20),
                                  child: Text(foodsnap['Contact'],style: GoogleFonts.alegreya(
                                    textStyle: Theme.of(context).textTheme.headline4,
                                    fontSize: 18,
                                    color: Colors.teal[800],),),
                                ),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 10,right: 20),
                                  child: Text(foodsnap['Insta_ID'],style: GoogleFonts.alegreya(
                                    textStyle: Theme.of(context).textTheme.headline4,
                                    fontSize: 18,
                                    color: Colors.teal[800],),),
                                ),
